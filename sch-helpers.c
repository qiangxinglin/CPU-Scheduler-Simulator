...
/* print appropriate error for case where numberOfProcesses exceed the MAX_PROCESSES
   or there is no processes in the .dat file */
void error_invalid_number_of_processes(int numberOfProcesses) {
    printf("Invalid number of processes, check the file please.");
    exit(-1);
}
